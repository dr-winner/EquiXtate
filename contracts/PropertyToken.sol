...
contract PropertyToken is ERC20, Ownable, ReentrancyGuard {
     ...
     */
    function purchaseTokens(uint256 amount, uint256 usdcAmount) external nonReentrant {
        require(amount <= tokensForSale, "Not enough tokens available for sale");
        ...
        // Note: In production, you would use a real USDC token contract
     ...
     */
    function getUnclaimedRentalIncome(address user) external view returns (uint256) {
