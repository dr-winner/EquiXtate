        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="glassmorphism p-6 rounded-lg hover:bg-space-deep-purple/40 transition-colors duration-200"
            >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <ul className="space-y-4">
                <li className="flex">
                  <span className="flex-shrink-0 h-6 w-6 rounded-full bg-space-neon-blue flex items-center justify-center mr-3 text-black font-bold">1</span>
                ...
                <li className="flex">
                  <span className="flex-shrink-0 h-6 w-6 rounded-full bg-space-neon-blue flex items-center justify-center mr-3 text-black font-bold">3</span>
                  <p className="text-gray-300">Rental income is distributed automatically to token holders via smart contracts</p>
                </li>
                <li className="flex">
                  <span className="flex-shrink-0 h-6 w-6 rounded-full bg-space-neon-blue flex items-center justify-center mr-3 text-black font-bold">4</span>
